            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="login.html"><i class="fa fa-user fa-fw"></i> Iniciar sesi√≥n</a>
                        </li>
                        <!--
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="forms.html"><i class="fa fa-github-alt fa-fw"></i> Ciencia FicciÛn</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-github-alt fa-fw"></i> FantasÌa …pica<!--<span class="fa arrow"></span>--></a>
                            <!--
                            <ul class="nav nav-second-level">
                                <li>
                ...
                <div class="col-lg-12">
                    ...
                    <main>
                        <div class="panel panel-primary">
                            <header class="panel-heading tituloLibro">TÌtulo del Libro </header>
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="row">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6 datosInfoLibro">
                                            <p class="plantillasLibro">TÌtulo: <span>${libro.titulo}</span></p>

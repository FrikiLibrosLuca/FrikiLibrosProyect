...
<head>
    ...
    <title>Menú para insertar Libros</title>
               ...
               <!-- 
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        -->
                        <li class="divider"></li>
                        <li><a href="Servlet"><i class="fa fa-sign-out fa-fw"></i> Cerrar Sesión</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="Servlet" method="GET">
                                        <div class="form-group">
                                            <label for="isbnLibro">Título</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="modificarIdioma" id="modificarIdioma" placeholder="Inglés">
                                        </div>                                        
                                        <div class="form-group">
